...
#define WLAN_SSID       "<nome da sua rede wifi>"
#define WLAN_PASS       "<senha da rede wifi>"

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "6n2ycq.messaging.internetofthings.ibmcloud.com"
#define AIO_SERVERPORT  1883                   // use 8883 for SSL
#define AIO_USERNAME    "use-token-auth"
#define AIO_KEY         "passw0rd"
#define MQTT_CLIENTID   "d:6n2ycq:NODEMCUESP12:esp8266-1"
...
void loop() {
  ...
  Serial.print(x);
  Serial.print("...");
  if (! mqttconn.publish("d:{\"teste\":\"1234\"}")) {
